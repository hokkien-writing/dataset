...
| Bring a chair | 挈茭~~𬃪~~(椅)來 | Khiĕ kaou-i lai |
...
| Feel of this | 摸~~只~~(此)箇物 | Mong chi kai muĕ |
...
| Send your servant to take it | 使~~爾~~(汝)囝子來挈 | Sai lur kin-kia lai khiĕ |
...
| Where was this book printed | 此冊~~值~~(底)處印 | Chi chĕ ti taw in |
| Whose house is this | 此厝是~~誰~~(底𫢗)~~個~~(个) | Chi chu,si ti-tiang kai |
| Who can tell | ~~誰個~~(底𫢗)能講 | Ti-tiang oi kong |
| Where has he gone | 伊去~~值~~(底)處 | I khur ti-taw |
...
| You know the truth | 眞理~~爾~~(汝)知了 | Chin li,lur chai liou |
...
| I think that is correct | 我想怎生有着 | Ua sie chie sey ~~n~~(u) tiĕ |
...
| Seed | 核 | Hut |
| tree | 柑~~𣜒~~(欉) | Ka chang |
| Pomegranate | 石榴~~丨~~(欉) | Siĕ liw chang |
